...
Por otro lado, El total de servicios de transporte recibidos por los anteriores procesos habiendo sido escalados corresponde a 6.82924 tkm + 1 tkm, para un total de 7.82924 tkm. Sin haber hecho escalamiento todavía, sabemos que el proceso que presta el servicio de transporte por camión tiene una salida de 1 tkm, de manera que para que este proceso preste un servicio de 6830.24125 tkm a los procesos que requieren este servcio, debemos multiplicar el proceso por el factor de escalamiento de 6830.2413, lo que daría además la necesidad de combustibe para este proceso de 47.8117 litros.
